...
// const axiosRetry = require('axios-retry').default; It doesn't work for some reason...
...
//   shouldRetry: (error) => {
//     // Check if the error is due to a timeout or a network error
//     const isTimeoutError = error.code === 'ECONNABORTED'; // Axios timeout error code
//     const isNetworkError = error.code === 'ECONNRESET'; // Network-related error code
//     return isTimeoutError || isNetworkError;
//   },
//   onRetry: (retryCount, error) => {
//     log.debug(`Retry attempt ${retryCount} due to error: ${error?.stack}`);
//   },
// });
