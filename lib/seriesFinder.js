...
function find(input) {
  const cleanedInput = removeJunk(input, defaultConfig.junkToFilter);
  const {
    volumeNumber,
    updatedInput,
    hasVolumeNumber,
  } = extractVolumeNumber(cleanedInput, defaultConfig.volumeNumberFilters);
