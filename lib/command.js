...
async function zipDirectory(sourceDir, destinationZip) {
  try {
    return await callProgram('7z', [
      ...
      '-mmt1', // Keep 7z from hanging https://superuser.com/questions/1738335/p7zip-stuck-at-zipping-warning-no-such-file-or-directory
...
async function getArchives(startPath, extensions = ['7z', 'rar', 'zip', 'cbr', 'cbz', 'cb7'], context = {}) {
